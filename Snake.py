...
press = (0, width)  # 0 refers to x, 1 refers to y
...
while not done:
    ...
    if pressed == pygame.K_UP and press != (1, height):
        y -= height
        press = (1, -(height))
    elif pressed == pygame.K_DOWN and press != (1, -(height)):
        y += height
        press = (1, height)
    elif pressed == pygame.K_LEFT and press != (0, width):
        x -= width
        press = (0, -(width))
    elif pressed == pygame.K_RIGHT and press != (0, -(width)):
        x += width
        press = (0, width)
    else:
        if press[0] == 0:
